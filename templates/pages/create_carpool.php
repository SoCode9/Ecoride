<main>
    <div class="flex-row flex-between">
        <h1 class="pageTitle bold">Proposer un covoiturage</h1>
        <a href="../controllers/user_space.php" class="btn"
            style="border: 2px solid #4D9856; background-color:var(--col-light-grey);">Retourner à l'espace
            utilisateur</a>
    </div>

    <form action="../back/carpool/create.php" method="POST" class="block-column-g20" style="gap: 20px;">
        <div class="flex-row">
